...
class KindleHighlight; end

class KindleHighlight::KindleFormat
...
class KindleHighlight::XML < KindleHighlight::KindleFormat
  def output
...
class KindleHighlight::HTML < KindleHighlight::KindleFormat
  def output
    output_html
    copy_styles
  end
